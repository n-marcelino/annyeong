...
<form method="POST" id="form-container" action="/users">
    ...
    <div class="mb-2">
        ...
        <input type="text" class="border-[3px] border-pink-900 rounded-[50px] bg-input placeholder-gray-600 text-center ml-16 mb-2 mt-24 p-2 w-9/12" name="fname" value="{{old('fname')}}" placeholder="First Name" />
